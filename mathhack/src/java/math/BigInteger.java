...
public class BigInteger extends Number implements Comparable<BigInteger> {
    static {
        System.out.println("Hello Voxxed Days Athens");
    }
    ...
    private static BigInteger multiplyToomCook3(BigInteger a, BigInteger b) {
        ...
        MultiplyTask v0task = new MultiplyTask(a0, b0);
        v0task.fork();
        da1 = a2.add(a0);
        db1 = b2.add(b0);
        ...
        MultiplyTask vatask = new MultiplyTask(da1, db1);
        vatask.fork();
    ...
    private BigInteger squareToomCook3() {
        ...
        SquareTask v0task = new SquareTask(a0);
        v0task.fork();
        da1 = a2.add(a0);
        vm1 = da1.subtract(a1).square();
        da1 = da1.add(a1);
        v0 = v0task.join();
        SquareTask v1task = new SquareTask(da1);
        v1task.fork();
        vinf = a2.square();
